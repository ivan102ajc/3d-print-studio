...
function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['hero', 'about', 'services', 'printers', 'materials', 'calculator', 'gallery', 'location', 'contact'];
    ...
    <div className={`min-h-screen ${bgMain} ${textPrimary} font-['Inter'] overflow-x-hidden transition-colors duration-300`}>
      ...
      <section id="hero" className="relative z-10 min-h-screen flex items-center justify-center px-4 py-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className={`text-lg sm:text-2xl ${textSecondary} mb-3 sm:mb-4 max-w-3xl mx-auto px-2`}>
            Профессиональная 3D-печать и моделирование
          </p>
          <p className={`${textMuted} mb-8 sm:mb-10 max-w-2xl mx-auto text-sm sm:text-lg px-2`}>
            От прототипа до серии. 6 принтеров, 6+ материалов, неограниченные возможности.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            <button onClick={() => scrollTo('calculator')} className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold hover:from-cyan-400 hover:to-blue-500 transition-all duration-300 shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 hover:scale-105 text-sm sm:text-base">
              Рассчитать стоимость
            </button>
            <button onClick={() => scrollTo('about')} className={`w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 rounded-xl border border-cyan-500/30 text-cyan-500 font-semibold ${hoverBg} transition-all duration-300 hover:scale-105 text-sm sm:text-base`}>
              Узнать больше
            </button>
          </div>
          ...
          <div className="mt-12 sm:mt-16 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 max-w-3xl mx-auto px-2">
            {[
              ...
              <div key={i} className={`p-3 sm:p-4 rounded-xl ${bgCard} border ${borderMain} backdrop-blur-sm`}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 mt-10 sm:mt-12">
            ...
            <div className="relative group">
              ...
              <div className={`relative ${bgCard} rounded-2xl p-5 sm:p-6 border ${borderMain} ${borderHover} transition-all duration-300`}>
                ...
                <div className={`text-xs ${textMutedLight} space-y-1`}>
                  <div>• FDM технология</div>
                  <div>• 6+ материалов</div>
                  <div>• От 8 ₽/грамм</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className={`relative ${bgCard} rounded-2xl p-5 sm:p-6 border ${borderMain} ${borderHover} transition-all duration-300`}>
                ...
                <div className={`text-xs ${textMutedLight} space-y-1`}>
                  <div>• По чертежам и эскизам</div>
                  <div>• Реверс-инжиниринг</div>
            ...
            <div className="relative group sm:col-span-2 lg:col-span-1">
              ...
              <div className={`relative ${bgCard} rounded-2xl p-5 sm:p-6 border ${borderMain} ${borderHover} transition-all duration-300`}>
                ...
                <div className={`text-xs ${textMutedLight} space-y-1`}>
                  <div>• Высокая точность</div>
                  <div>• Любые объекты</div>
            ...
            <div className={`relative ${bgCard} rounded-2xl p-4 sm:p-8 border ${borderMain}`}>
                  ...
                  <div className="flex gap-2">
                    {[
                      ...
                      <button
                        ...
                        className={`flex-1 py-2 sm:py-2.5 px-2 sm:px-3 rounded-lg text-xs sm:text-sm transition-all whitespace-nowrap ${calcComplexity === c.val ? 'bg-cyan-500/20 border border-cyan-500/50 text-cyan-400' : `${bgCardAlt} border ${borderMain} ${textMuted} ${borderHover}`}`}
                      >
                        {c.label}
                      </button>
                    ))}
                ...
                <div className="flex items-end">
                  <div className={`flex items-center gap-3 p-3 rounded-xl ${bgCardAlt} w-full`}>
                    <button
                      ...
                      className={`w-11 h-6 rounded-full transition-all relative flex-shrink-0 ${calcUrgent ? 'bg-cyan-500' : isDark ? 'bg-white/10' : 'bg-gray-300'}`}
                    >
              ...
              <div className="mt-6 text-center">
                <a 
                  ...
                  className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold hover:from-cyan-400 hover:to-blue-500 transition-all duration-300 shadow-lg shadow-cyan-500/25 text-sm sm:text-base"
                >
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mt-10 sm:mt-12">
            ...
            <div className="space-y-4 sm:space-y-6">
                ...
                <div className="space-y-3">
                  <a href="https://t.me/ivanchay0937" target="_blank" rel="noopener noreferrer" className={`flex items-center gap-3 p-3 rounded-xl ${bgCardAlt} ${hoverBg} transition-colors`}>
                    ...
                    <div className="min-w-0">
                      ...
                      <div className={`${textMuted} text-xs sm:text-sm`}>Личные сообщения</div>
                    </div>
                  </a>
              ...
              <div className={`${bgCard} rounded-2xl p-5 sm:p-6 border ${borderMain}`}>
                ...
                <a href="https://sites.google.com/view/protolab-3d/главная-страница" target="_blank" rel="noopener noreferrer" className={`flex items-center gap-3 p-3 rounded-xl ${bgCardAlt} ${hoverBg} transition-colors`}>
                  ...
                  <div className="min-w-0">
                    <div className={`${textPrimary} font-medium text-sm sm:text-base truncate`}>protolab-3d</div>
                    <div className={`${textMuted} text-xs sm:text-sm`}>Google Sites</div>
                  </div>
                </a>
              </div>
              ...
              <div className={`${bgCard} rounded-2xl p-5 sm:p-6 border ${borderMain}`}>
                ...
                <div className={`space-y-2 sm:space-y-3 ${textSecondary} text-xs sm:text-sm`}>
                  ...
                  <div className="flex items-start gap-2">
                    <span className="text-cyan-400 flex-shrink-0">→</span>
                    <span className="text-yellow-400 font-medium">Скидки при больших заказах!</span>
                  </div>
                </div>
              </div>
            </div>
...
function SectionTitle({ title, subtitle, isDark }: { title: string; subtitle: string; isDark: boolean }) {
  return (
    <div className="text-center px-2">
      <h2 className="font-['Orbitron'] text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
        {title}
      </h2>
